  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
        ...
        <span style={{ fontWeight: 700, fontSize: 17 }}>{fmt?.label}</span>
        <span style={{ color: 'var(--muted)', fontSize: 13 }}>• {tournament.players.length} players</span>
        {bracket.champion && (
          <span style={{ marginLeft: 'auto', background: '#854d0e', color: '#fef08a', padding: '4px 14px', borderRadius: 99, fontSize: 13, fontWeight: 700 }}>
